...
INSTALLED_APPS = [
    ...
    "notifications",  # Notification and messaging app
]
...
WSGI_APPLICATION = "laborcon.wsgi.application"
ASGI_APPLICATION = "laborcon.asgi.application"  # For WebSocket support
